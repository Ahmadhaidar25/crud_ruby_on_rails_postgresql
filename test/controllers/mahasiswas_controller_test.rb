...
class MahasiswasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mahasiswa" do
    assert_difference("Mahasiswa.count") do
      post mahasiswas_url, params: { mahasiswa: { jenis_kelamin: @mahasiswa.jenis_kelamin, jurusan: @mahasiswa.jurusan, nama_mahasiswa: @mahasiswa.nama_mahasiswa, npm: @mahasiswa.npm } }
    end
  ...
  test "should update mahasiswa" do
    patch mahasiswa_url(@mahasiswa), params: { mahasiswa: { jenis_kelamin: @mahasiswa.jenis_kelamin, jurusan: @mahasiswa.jurusan, nama_mahasiswa: @mahasiswa.nama_mahasiswa, npm: @mahasiswa.npm } }
